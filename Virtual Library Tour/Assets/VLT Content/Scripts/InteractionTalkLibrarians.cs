...
public class InteractionTalkLibrarians : MonoBehaviour {
	...
	void Update ()
    {
        ...
        // If close distance is less than trigger distance and if UI is not displaying, then call the QuestionAnswer void, display UI and enable mouse.
        ...
        // Otherwise, if UI is displaying, then disable the question, answer panels and remove UI as well as removing the mouse too.
        else
        {
            if(isUIDisplaying)
            {
